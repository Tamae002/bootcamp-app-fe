...
export default function Dashboard() {
  ...
  const upcomingCourses = [
    { id: 1, title: 'GameDev Batch 2', progress: '32/13/26', note: 'Pertemuan 1' },
    { id: 2, title: 'GameDev Batch 2', progress: '32/13/26', note: 'Pertemuan 1' },
    { id: 3, title: 'GameDev Batch 2', progress: '32/13/26', note: 'Pertemuan 1' }
  ]

  const classes = Array(8).fill(null).map((_, i) => ({
    id: i + 1,
    title: `GameDev Batch ${i + 1}`,
    description: 'deskripsi ini adalah adalah adalah adelaheaeasdaedasdaedasdaedasdaedasdaedasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasdasd'
  }))
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="relative mb-12">
          <div className="rounded-lg overflow-hidden shadow-lg bg-white flex">
            {/* Top Section - Background Image (Left & Top) */}
            <div className="w-full">
              <div className="relative h-58">
                {/* Background: image (replacing yellow) with vertical purple overlay */}
                <div
                ...
                {/* Small purple overlay band at bottom so gradient isn't full-height */}
                <div
                ...
                {/* Welcome and Homepage Text - Positioned near boundary */}
            ...
            {/* Profile Photo - Overlapping on the left */}
            ...
            {upcomingCourses.map((course) => (
              ...
              >
                <div className="flex-1 pr-4">
                  <div className="text-sm text-black">{course.title} :</div>
                  <div className="text-xs text-black mt-1">{course.note}</div>
                </div>
                <div className="text-sm text-black text-right">{course.progress}</div>
              </div>
            ))}
          </div>
        </div>
...
<div className="mb-12">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
    {classes.map((classItem) => (
      <div 
        key={classItem.id} 
        className="bg-gray-100 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all cursor-pointer p-3"
      >
        {/* Image Header dengan padding dari tepi card - landscape */}
