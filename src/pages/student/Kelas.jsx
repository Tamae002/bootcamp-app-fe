  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
        {/* Welcome Section */}
        <div className="mb-8">
          <p className="text-sm text-gray-600 mb-1">Welcome {user?.name || 'Raya'}</p>
          <h1 className="text-2xl font-bold text-gray-900">Halaman Kelas</h1>
        </div>

        {/* Banner */}
        <div className="mb-8 rounded-lg bg-gradient-to-r from-purple-600 to-purple-700 px-8 py-32 text-center shadow-lg">
          <h2 className="text-5xl font-bold text-white">Banner</h2>
        </div>

        {/* Kelas Saya Section */}
        <div className="mb-12">
          <h2 className="mb-6 text-2xl font-bold text-gray-900 border-b-2 border-black pb-2">
            Kelas Saya
          </h2>
          ...
          {classes.length > 0 ? (
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {classes.map((classItem, index) => (
                ...
                >
                  {/* Image dengan gradient biru/cyan */}
                  <div 
                    className="h-40 bg-gradient-to-br from-blue-900 via-cyan-600 to-cyan-400"
                    style={{
