...
export default function Dashboard() {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-full overflow-x-hidden">
      <div className="mb-6">
        <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-100">Welcome {displayName}</p>
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-slate-800 dark:text-slate-100">Beranda</h1>
      </div>
